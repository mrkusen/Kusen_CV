...
tribble(
  ...
  "Master of Demography", "Expected November 2022", "Chulalongkorn University", "Bangkok, Thailand",
...
# Country Experience
Ukraine, Indonesia, Philippines, Fiji, Papua New Guinea, Haiti, Central African Republic (CAR), Democratic Republic of the Congo (DRC), Togo, Sierra Leone, United States, Thailand, Poland and France
...
"Papua New Guinea","Haiti", "Central African Republic", "Democratic Republic of the Congo", "Togo", "Sierra Leone", "USA", "Thailand","France","Denmark","Bhutan","Sri Lanka")
country_work <- cbind(country_w,"worked")

country_s <- c("Nigeria","Chad","Burkina Faso","Niger","Ghana","South Sudan","Tanzania","Afghanistan","Pakistan","India","Bangladesh","Sri Lanka","Myanmar","Syria","Yemen","Uganda","Kenya","Mongolia","Mongolia")
