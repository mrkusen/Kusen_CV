...
address: "Centric Ari Station, Phaya Thai, Bangkok, Thailand"
...
* Public Health professional with 9 years of experience working in and providing technical support to programs in humanitarian and development settings. 
* Currently enrolled in an Master's in Demography. 
* Skills in data analysis, statistical analysis, data visualization, monitoring & evaluation, management, leadership, coordination, capacity development, program design, budget management and reporting. 
...
tribble(
  ...
  "Master of Demography", "Expected May 2022", "Chulalongkorn University", "Bangkok, Thailand",
...
tribble(
  ...
  2014, "Minimum Initial Service Package (MSIP) for Reproductive Health In Crisis - IAWG", "online"
) %>%  
  brief_entries(
    Type,
    Year, 
...
# Country Experience
Indonesia, Philippines, Fiji, Papua New Guinea, Haiti, Central African Republic (CAR), Democratic Republic of the Congo (DRC), Togo, Sierra Leone, United States, Thailand and France
...
CV created using RMarkdown in RStudio. Reproducible code and data can be found at https://github.com/mrkusen/CV